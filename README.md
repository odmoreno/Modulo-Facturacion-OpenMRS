...
# Modulo-Facturacion-OpenMRS

This repository contains the Modulo-Facturacion-OpenMRS OpenMRS Open Web App.
...
This will create a file called `modulo-facturacion-openmrs.zip` file in the `dist` directory,
...
This will build and deploy the app to the `/home/oscar/Downloads/openmrs/referenceapplication-standalone-2.7.0/appdata\\owa `
...
```js
{
  "LOCAL_OWA_FOLDER": "/home/oscar/Downloads/openmrs/referenceapplication-standalone-2.7.0/appdata\\owa "
}
```
...
{
  "LOCAL_OWA_FOLDER": "/home/oscar/Downloads/openmrs/referenceapplication-standalone-2.7.0/appdata\\owa ",
  "APP_ENTRY_POINT": "http://localhost:8081/openmrs-standalone/owa/modulo-facturacion-openmrs/index.html"
}
```
